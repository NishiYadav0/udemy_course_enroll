...
- [License](#license)
- [📦 Chapter 1 — Full Deployment Walkthrough (Oracle Cloud, start to finish)](docs/DEPLOYMENT_GUIDE.md)
- [🖥️ Chapter 2 — Front-End Setup (Telegram, Channels, Udemy — zero SSH)](docs/FRONTEND_SETUP.md)

---

## New here? Start with the two guides below

**[📦 Chapter 1 — Full Deployment Walkthrough](docs/DEPLOYMENT_GUIDE.md)** —
Oracle Cloud account and VM creation, security list/firewall rules, SSH,
Python, getting the code onto the server, and deploying both the bot and the
Admin Panel. Start to finish, for someone who has nothing set up yet.

**[🖥️ Chapter 2 — Front-End Setup](docs/FRONTEND_SETUP.md)** — everything
after Chapter 1, done entirely in a browser: claiming your admin account,
logging in to Telegram, adding channels by name, and adding your Udemy
account. Zero SSH.
